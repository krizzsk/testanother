...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  ...
  <tr style="height:20px">
    ...
    <td style="position:relative;">
      <input dojoType="dijit.form.TextBox" id="saveGroup" name="saveGroup" class="input" style="width:165px" value="" />
	    <button title="<?php echo i18n('saveGroup');?>" dojoType="dijit.form.Button"
                id="saveGroupButton" name="saveGroupButton" class="resetMargin roundedButton notButton" style="height:24px;width:32px;margin-top:-5px;"
...
function drawResourceTile($res,$dndSource){
  ...
  $name=($res->resourceName)?$res->resourceName:$res->name;
