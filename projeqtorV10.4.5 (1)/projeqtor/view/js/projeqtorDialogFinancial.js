...
function resourceCostUpdateRole() {
  ...
  if (dijit.byId("resourceCostIdRole").get('value')) {
    dojo.xhrGet({
      url:'../tool/getSingleData.php?dataType=resourceCostDefault&idRole=' + dijit.byId("resourceCostIdRole").get('value') + '&isSubContractor='+dijit.byId("subcontractor").get("checked")+'&csrfToken=' + csrfToken,
      handleAs:"text",
      load:function(data) {
