...
INSERT INTO `${prefix}navigation` (`name`, `idParent`, `idMenu`, `sortOrder`, `idReport`, `tag`, `moduleName`) VALUES
('menuCriticalResources', 1, 284, 75,0, NULL, NULL);
...
INSERT INTO `${prefix}navigation` (`name`, `idParent`, `idMenu`, `sortOrder`, `idReport`, `tag`, `moduleName`) VALUES
('menuResourceMaterial', 128, 285, 45,0, NULL, NULL);
